/**
 * Opens a window in order to create content for the user. Once a content is created, refresh is called in order to refresh the area that is displaying the content.
 */
...
public class UserContentCreator extends JFrame {
	...
	public UserContentCreator(Refreshable refreshable, User user) {
		...
		btnPublish.addActionListener(new ActionListener() {
			 ...
			 * we have an image, if we do creates content for given user, else creates
			 * content without image, else uses JOptionPane to give the corresponding error.
			 */
			public void actionPerformed(ActionEvent e) {
		...
		btnDiscard.addActionListener(new ActionListener() {
			/**
			 * Simply closes the window without publishing the changes.
			 */
			public void actionPerformed(ActionEvent e) {
				dispose();
			}
